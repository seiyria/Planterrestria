...
module.exports = function makeWebpackConfig() {
  ...
  config.module = {
    rules: [
      ...
      {test: /\.css$/, include: root('src','client', 'app'), loader: 'raw-loader!postcss-loader'},
      ...
      // all css required in src/app files will be merged in js files
      {test: /\.(scss|sass)$/, exclude: root('src', 'client', 'style'), loader: 'raw-loader!postcss-loader!sass-loader'},

      // support for .html as raw text
      // todo: change the loader to something that adds a hash to images
      {test: /\.html$/, loader: 'raw-loader',  exclude: root('src', 'client', 'public')}
    ]
  };
